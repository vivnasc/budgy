      ...
      <main className="-mt-2 space-y-6">
        ...
        <section className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-4">
          <div className="flex items-center justify-between mb-3">
            <h2 className="font-semibold text-sm text-white">Resumo do Mês</h2>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-emerald-400">+{totalIncome.toLocaleString("pt-MZ")}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-rose-400">-{totalExpenses.toLocaleString("pt-MZ")}</p>
              </div>
            </div>
          </div>
        </section>
