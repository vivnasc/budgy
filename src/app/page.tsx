...
// Force static generation - zero origin transfer on every visit
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="relative">
              <Image src="/budgy-logo.webp" alt="BUDGY" width={36} height={36} className="rounded-xl shadow-md animate-bounce-slow" priority />
            </div>
                  ...
                  <div className="bg-gray-900 rounded-[2rem] overflow-hidden">
                    ...
                    <div className="bg-emerald-500 px-5 pt-3 pb-5">
                      <div className="flex items-center gap-2 mb-3">
                        <Image src="/budgy-logo.webp" alt="" width={28} height={28} className="rounded-lg" />
      ...
      <section className="bg-white py-20 sm:py-28">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl p-10 sm:p-14 shadow-glow-emerald">
            <Image src="/budgy-logo.webp" alt="BUDGY" width={56} height={56} className="rounded-2xl shadow-lg mx-auto mb-6 animate-bounce-slow" />
      ...
      <footer className="bg-gray-900 px-4 sm:px-6 py-10">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2.5">
            <Image src="/budgy-logo.webp" alt="BUDGY" width={28} height={28} className="rounded-lg" />
