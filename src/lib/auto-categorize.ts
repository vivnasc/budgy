...
const SYSTEM_RULES: CategorizationRule[] = [
  ...
  { pattern: "pescas do sul", isRegex: false, category: "Alimentação", confidence: 0.9, confirmCount: 0, source: "system" },
  { pattern: "pescas sa", isRegex: false, category: "Alimentação", confidence: 0.9, confirmCount: 0, source: "system" },
  { pattern: "bazar central", isRegex: false, category: "Compras", confidence: 0.85, confirmCount: 0, source: "system" },
  { pattern: "banca no", isRegex: false, category: "Alimentação", confidence: 0.8, confirmCount: 0, source: "system" },
  { pattern: "sm essop", isRegex: false, category: "Alimentação", confidence: 0.85, confirmCount: 0, source: "system" },
  { pattern: "bebe giro", isRegex: false, category: "Família", confidence: 0.95, confirmCount: 0, source: "system" },
  { pattern: "mozapparels", isRegex: false, category: "Roupa", confidence: 0.9, confirmCount: 0, source: "system" },
  { pattern: "studio daisy", isRegex: false, category: "Beleza & Cuidados", confidence: 0.9, confirmCount: 0, source: "system" },
  { pattern: "aesthetic", isRegex: false, category: "Beleza & Cuidados", confidence: 0.9, confirmCount: 0, source: "system" },
  { pattern: "clin aesthetic", isRegex: false, category: "Beleza & Cuidados", confidence: 0.95, confirmCount: 0, source: "system" },
  { pattern: "ferragens", isRegex: false, category: "Casa", confidence: 0.85, confirmCount: 0, source: "system" },
  { pattern: "polana", isRegex: false, category: "Casa", confidence: 0.75, confirmCount: 0, source: "system" },
  { pattern: "maputo internati", isRegex: false, category: "Compras", confidence: 0.7, confirmCount: 0, source: "system" },
  { pattern: "vthebestpdf", isRegex: false, category: "Subscrições", confidence: 0.85, confirmCount: 0, source: "system" },
  { pattern: "mega distr", isRegex: false, category: "Alimentação", confidence: 0.95, confirmCount: 0, source: "system" },
  { pattern: "alfa super", isRegex: false, category: "Alimentação", confidence: 0.95, confirmCount: 0, source: "system" },
  { pattern: "riyouf sup", isRegex: false, category: "Alimentação", confidence: 0.95, confirmCount: 0, source: "system" },
  { pattern: "premier gr", isRegex: false, category: "Alimentação", confidence: 0.9, confirmCount: 0, source: "system" },
  { pattern: "consultori", isRegex: false, category: "Saúde", confidence: 0.85, confirmCount: 0, source: "system" },
  { pattern: "mahomed", isRegex: false, category: "Compras", confidence: 0.7, confirmCount: 0, source: "system" },
  { pattern: "applecombill", isRegex: false, category: "Subscrições", confidence: 0.98, confirmCount: 0, source: "system" },
  { pattern: "paypal", isRegex: false, category: "Subscrições", confidence: 0.8, confirmCount: 0, source: "system" },
  { pattern: "ms comercio", isRegex: false, category: "Compras", confidence: 0.7, confirmCount: 0, source: "system" },
  ...
  { pattern: "replicate", isRegex: false, category: "Subscrições", confidence: 0.9, confirmCount: 0, source: "system" },
  { pattern: "distrokids", isRegex: false, category: "Subscrições", confidence: 0.9, confirmCount: 0, source: "system" },
  { pattern: "botle store", isRegex: false, category: "Restaurantes", confidence: 0.85, confirmCount: 0, source: "system" },
  // Transferências por NIB (METIX) — saída para outra conta/pessoa, não é compra
  { pattern: "via nib enviada", isRegex: false, category: "Transferência", confidence: 0.7, confirmCount: 0, source: "system" },
  { pattern: "metix", isRegex: false, category: "Transferência", confidence: 0.7, confirmCount: 0, source: "system" },
  // ── Merchants África do Sul (viagens/compras Ballito-Durban) ──
  { pattern: "clicks", isRegex: false, category: "Saúde", confidence: 0.85, confirmCount: 0, source: "system" },
  { pattern: "sportscene", isRegex: false, category: "Compras", confidence: 0.85, confirmCount: 0, source: "system" },
  { pattern: "cotton on", isRegex: false, category: "Compras", confidence: 0.85, confirmCount: 0, source: "system" },
  { pattern: "istore", isRegex: false, category: "Compras", confidence: 0.85, confirmCount: 0, source: "system" },
  { pattern: "incredible connection", isRegex: false, category: "Compras", confidence: 0.85, confirmCount: 0, source: "system" },
  { pattern: "shell", isRegex: false, category: "Combustível", confidence: 0.85, confirmCount: 0, source: "system" },
